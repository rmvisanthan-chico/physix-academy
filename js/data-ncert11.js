    ...
    lessons:[
      { id:'ncert11.units.main', title:'Units, Dimensions & Errors', mins:22, content:[
        ...
        {formulas:[
          ...
          {tex:'A = l \\times b', name:'Area — dimension', note:'SI: m², Dimension: [L²]'},
          {tex:'V = l \\times b \\times h', name:'Volume — dimension', note:'SI: m³, Dimension: [L³]'},
          {tex:'v = \\frac{\\text{displacement}}{\\text{time}}', name:'Velocity — dimension', note:'SI: m/s, Dimension: [LT⁻¹]'},
          {tex:'a = \\frac{v}{t}', name:'Acceleration — dimension', note:'SI: m/s², Dimension: [LT⁻²]'},
          {tex:'F = ma', name:'Force — dimension', note:'SI: N = kg·m/s², Dimension: [MLT⁻²]'},
          {tex:'p = mv', name:'Momentum — dimension', note:'SI: kg·m/s, Dimension: [MLT⁻¹]'},
          {tex:'J = Ft', name:'Impulse — dimension', note:'SI: kg·m/s, Dimension: [MLT⁻¹]'},
          {tex:'L = mvr', name:'Angular momentum — dimension', note:'SI: kg·m²/s, Dimension: [ML²T⁻¹]'},
          {tex:'P = \\frac{F}{A}', name:'Pressure — dimension', note:'SI: Pa = kg/(m·s²), Dimension: [ML⁻¹T⁻²]'},
          {tex:'\\sigma = \\frac{F}{A}', name:'Stress — dimension', note:'SI: Pa = kg/(m·s²), Dimension: [ML⁻¹T⁻²]'},
          {tex:'W = Fs', name:'Work — dimension', note:'SI: J = kg·m²/s², Dimension: [ML²T⁻²]'},
          {tex:'U = mgh', name:'Potential energy — dimension', note:'SI: J = kg·m²/s², Dimension: [ML²T⁻²]'},
          {tex:'\\tau = Fr', name:'Torque — dimension', note:'SI: N·m = kg·m²/s², Dimension: [ML²T⁻²]'},
          {tex:'\\text{Strain} = \\frac{\\Delta l}{l}', name:'Strain — dimension', note:'No unit, Dimensionless [M⁰L⁰T⁰]'},
          {tex:'Y = \\frac{Fl}{A\\Delta l}', name:"Young's modulus — dimension", note:'SI: Pa = kg/(m·s²), Dimension: [ML⁻¹T⁻²]'},
          {tex:'f = \\frac{1}{T}', name:'Frequency — dimension', note:'SI: Hz = 1/s, Dimension: [T⁻¹]'},
          {tex:'\\theta = \\frac{\\text{arc length}}{\\text{radius}}', name:'Angle — dimension', note:'No unit (rad), Dimensionless [M⁰L⁰T⁰]'},
          {tex:'P = \\frac{W}{t}', name:'Power — dimension', note:'SI: W = kg·m²/s³, Dimension: [ML²T⁻³]'},
          {tex:'I = \\frac{\\text{Energy}}{\\text{Area} \\times \\text{time}}', name:'Intensity — dimension', note:'SI: W/m² = kg/s³, Dimension: [MT⁻³]'}
        ]},
        {h:'Dimensional formulae — quick table'},
        {table:{head:['Quantity','Formula','SI Units','Dimensional Formula'], rows:[
          ['Area','l × b','m²','[L²]'],
          ['Volume','l × b × h','m³','[L³]'],
          ['Velocity','displacement / time','m/s','[LT⁻¹]'],
          ['Acceleration','velocity / time','m/s²','[LT⁻²]'],
          ['Force','m × a','N (kg·m/s²)','[MLT⁻²]'],
          ['Momentum','p = mv','kg·m/s','[MLT⁻¹]'],
          ['Impulse','J = Ft','kg·m/s','[MLT⁻¹]'],
          ['Angular Momentum','L = mvr','kg·m²/s','[ML²T⁻¹]'],
          ['Pressure','P = F/A','kg/(m·s²)','[ML⁻¹T⁻²]'],
          ['Stress','σ = F/A','kg/(m·s²)','[ML⁻¹T⁻²]'],
          ['Work','W = F·s','kg·m²/s²','[ML²T⁻²]'],
          ['Potential Energy','U = mgh','kg·m²/s²','[ML²T⁻²]'],
          ['Torque','F·r','kg·m²/s²','[ML²T⁻²]'],
          ['Strain','Δl / l','no unit','Dimensionless'],
          ["Young's modulus Y",'Fl / AΔl','kg/(m·s²)','[ML⁻¹T⁻²]'],
          ['Frequency','1 / T','1/s','[T⁻¹]'],
          ['Angle','arc length / radius','no unit','Dimensionless'],
          ['Power','Work / Time','kg·m²/s³','[ML²T⁻³]'],
          ['Intensity','Energy / (Area × time)','kg/s³','[MT⁻³]']
        ]}},
